$( function ()
{
	...
	var inicializar = function ()
	{
		...
		$( "#tabela-usuario" ).find( ".a-link-excluir" )
			.off( "click" )
			.on( "click", function ( ev )
			{
				...
				var $link = $( this );
				var nomeUsuario = Common.gEscapeHTML( $link.attr( "data-nome-usuario" ) );

				Common.messageBoxSimNao($, $.TITULO_DLG, Common.formatarString($.MSG_USUARIO_CONFIRMA_EXCLUSAO, nomeUsuario ), function () { fnConfirmaExclusao( $link ); }, null );

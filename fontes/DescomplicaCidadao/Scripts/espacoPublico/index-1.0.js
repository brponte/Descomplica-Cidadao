$( function ()
{
	...
	var inicializar = function ()
	{
		...
		$( "#tabela-espaco-publico" ).find( ".a-link-excluir" )
			.off( "click" )
			.on( "click", function ( ev )
			{
				...
				var $link = $( this );
				var descricaoTitulo = Common.gEscapeHTML( $link.attr( "data-titulo" ) );

				Common.messageBoxSimNao($, $.TITULO_DLG, Common.formatarString($.MSG_ESPACO_PUBLICO_CONFIRMA_EXCLUSAO, descricaoGrupoInvestimento ), function () { fnConfirmaExclusao( $link ); }, null );

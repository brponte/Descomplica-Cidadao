$( function ()
{
	...
	var inicializar = function ()
	{
		...
		$( "#tabela-imposto-usuario" ).find( ".a-link-excluir" )
			.off( "click" )
			.on( "click", function ( ev )
			{
				...
				var $link = $( this );
				var sigla = Common.gEscapeHTML( $link.attr( "data-sigla-imposto-usuario" ) );
				var ano   = Common.gEscapeHTML($link.attr("data-ano-imposto-usuario"));
				var cpf   = Common.gEscapeHTML($link.attr("data-cpf-imposto-usuario"));

				Common.messageBoxSimNao($, $.TITULO_DLG, Common.formatarString($.MSG_IMPOSTO_USUARIO_CONFIRMA_EXCLUSAO, sigla, ano, cpf ), function () { fnConfirmaExclusao( $link ); }, null );

$( function ()
{
	...
	var inicializar = function ()
	{
		...
		$( "#tabela-motivo" ).find( ".a-link-excluir-motivo" )
			.off( "click" )
			.on( "click", function ( ev )
			{
				...
				var $link = $( this );
				var descricaoMotivo = Common.gEscapeHTML( $link.attr( "data-desc-motivo" ) );

				Common.messageBoxSimNao( $, $.TITULO_DLG, Common.formatarString( $.MSG_MOTIVO_CONFIRMA_EXCLUSAO, descricaoMotivo ), function () { fnConfirmaExclusao( $link ); }, null );
